...
- Current `assets/img/firework-launcher-demo.png` animation settings: `360x360`, 15 synthetic fireworks, deterministic particle seeds, `284` frames, `50ms` per frame, and a seeded random-gap launch schedule.
