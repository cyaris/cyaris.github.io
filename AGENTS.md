...
- Current `assets/img/firework-launcher-demo.png` animation settings: `360x360`, 15 synthetic fireworks, deterministic particle seeds, `355` frames, `50ms` per frame, `1.25x` slow-motion timing, and a seeded random-gap launch schedule.
