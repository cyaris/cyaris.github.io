...
- `assets/css/custom.css`
  ...
  - Places project page GitHub badge buttons and repository metadata pills in a left-aligned header stack.
  - Hides tags on Blog and Projects listing pages.
  - Shows linked repository creation and latest default-branch commit date pills on Projects listings from `_data/github_repos.yml`, generated by `scripts/update-github-repo-dates.mjs`.
