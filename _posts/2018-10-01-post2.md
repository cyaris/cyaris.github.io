...
type: post
thumbnail-img: /assets/img/mta-nyc-subway-leaving-union.jpeg
thumbnail-fit: cover
thumbnail-position: left center
thumbnail-size: extra-small
---

<center><img src="{{ '/assets/img/mta-nyc-subway-leaving-union.jpeg' | relative_url }}" width="100%" height="100%" alt="An MTA subway train leaving Union Square station"></center>
...
![MTA Turnstile Graph 1]({{ '/assets/img/PassengerRatePriorityVsOther.png' | relative_url }})
...
![MTA Turnstile Graph 2]({{ '/assets/img/PassengerRatebyDayTopThreePriorityStations.png' | relative_url }})
...
![MTA Turnstile Graph 3]({{ '/assets/img/PassengerRatebyHourTopThreePriorityStations.png' | relative_url }})
