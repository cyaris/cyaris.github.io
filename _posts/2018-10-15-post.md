...
![Distribution of the Lowest Price per Pill for Each Drug]({{ '/assets/img/lowest_pill_price_distribution.png' | relative_url }})
...
![Values of Feature Coefficients with NADAC Highlighted in Red]({{ '/assets/img/coefficients_w_cost.png' | relative_url }})
...
![VIF Feature Weights with NADAC Highlighted in Red]({{ '/assets/img/feature_importance_w_cost.png' | relative_url }})
