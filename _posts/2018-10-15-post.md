...
subtitle: A lesson in feature weights.
tags: [data visualization, error metrics, feature weights, linear modeling, machine learning, matplotlib, model evaluation, python, sci-kit learn, seaborn]
---
