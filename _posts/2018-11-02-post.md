...
<style>
  .tableau-post-dashboard {
    margin-top: 32px;
  }
</style>

<div class="tableau-post-dashboard">
...
![Class Imbalance (Pre-Upsampling)]({{ '/assets/img/upsampling1.png' | relative_url }})
...
![Class Imbalance (Post-Upsampling)]({{ '/assets/img/upsampling2.png' | relative_url }})
