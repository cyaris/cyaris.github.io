...
subtitle: Extracting topics from the prophecies of Nostradamus.
gh-repo: cyaris/nostradamus_prophecies
gh-badge: [follow, star]
tags: [data visualization, machine learning, matplotlib, natural language processing, principal component analysis, python, scikit-learn, seaborn, singular value decomposition, tf-idf, topic modeling]
---
