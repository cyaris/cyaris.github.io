...
type: post
thumbnail-img: /assets/img/nostradamus.png
thumbnail-size: small
---

<center><img src="{{ '/assets/img/nostradamus.png' | relative_url }}" width="350" height="350" alt="Portrait of Nostradamus"></center>
...
This is the question I sought to answer by applying natural language processing to an almost 500-year-old document, Nostradamus's ["Les Propheties."](https://www.sacred-texts.com/nos/index.htm){:target="_blank" rel="noopener noreferrer"} Since its publication in 1555, the 942 quatrains of Nostradamus's most famous work have been re-applied to infamous events in every century since. From the rise of Hitler, to the attacks of September 11th, "Les Propheties" has solidified its legacy by finding new supporters in each generation who are willing to bet that Nostradamus predicted a given tragedy hundreds of years before it occurred.
...
![A Legacy in Google Trends]({{ '/assets/img/nostradamus_vs_prophecy_google_search.png' | relative_url }})
...
![Top 10 Words in "Les Propheties"]({{ '/assets/img/top_10_words.png' | relative_url }})
...
![prophecy_topics_1]({{ '/assets/img/prophecy_topics_1.png' | relative_url }})
...
![prophecy_topics_1]({{ '/assets/img/prophecy_topics_3.png' | relative_url }})
